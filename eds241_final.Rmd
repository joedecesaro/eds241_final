...
Based on the housing information from 1978, the incinerator was placed near houses that, on average, were sold for 18,000 adjusted dollars less than houses not near the incinerator placement. The p-value for the difference in houses near the incinerator is `r round(model2.1_sum$coefficients[2,4], 5)` and therefore statistically significant at the 0.01 level.
